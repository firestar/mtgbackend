...
async function main() {
  var server = http.createServer((req, res) => {
    Route.registry.call(req.url, req, res, {cardIndex: cardIndex, priceHistory:priceHistory, sessions:sessions, accountIndex:accountIndex, cardInventory:cardInventory});
  });
  server.listen(80, () => {
